...
3. Check existing GitHub Issues
   ...
   +2. Create a new issue with detailed reproduction steps.
4. Include your Chrome version and extension version
5. Provide example URLs where the issue occurs
...
+- [ ] **Feature**: Add an options page for advanced configuration.
+- [ ] **Feature**: Support for custom CSS selectors to target specific elements.
+- [ ] **Enhancement**: Add more translation languages (e.g., Hindi, Portuguese).
+- [ ] **Enhancement**: Implement a "dark mode" for the popup interface.
...
+- [ ] **Feature**: Allow users to provide their own API keys.
+- [ ] **Feature**: Whitelist/blacklist domains for automatic processing.
+- [ ] **Feature**: Add support for more currencies, including cryptocurrencies (BTC, ETH).
+- [ ] **Enhancement**: Offline mode using recently cached rates.
